...
class OrganizationOnboardingTest(AcceptanceTestCase):
    ...
    def test_onboarding_configure(self):
        project = Project.objects.create(slug='angular', platform='javascript-angular')
        ProjectKey.objects.filter(project=project).update(
            label='Default',
        ...
        self.browser.get(
            ...
            (self.org.slug, project.slug, project.platform))
